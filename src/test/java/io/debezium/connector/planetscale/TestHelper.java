...
public class TestHelper {
    ...
    public static final String TEST_UNSHARDED_KEYSPACE = "sandbox";
    public static final String TEST_SHARDED_KEYSPACE = "sandbox";
    public static final String TEST_EMPTY_SHARD_KEYSPACE = "sandbox";
    public static final String TEST_HEARTBEAT_KEYSPACE = "sandbox";
    public static final String TEST_NON_EMPTY_SHARD = "-80";
    public static final String TEST_SHARD = "";
    ...
    private static final String VTGATE_HOST = "aws.connect.psdb.cloud";
    ...
    public static Configuration.Builder defaultConfig(boolean hasMultipleShards,
        ...
        builder = builder
                ...
                .with("schema.history.internal.kafka.topic", "your-schema-history-topic")
