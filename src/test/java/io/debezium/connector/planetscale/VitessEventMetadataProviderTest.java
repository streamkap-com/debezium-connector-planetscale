...
import static io.debezium.connector.planetscale.TestHelper.TEST_GTID;
import static io.debezium.connector.planetscale.VgtidTest.TEST_GTID2;
import static io.debezium.connector.planetscale.VgtidTest.TEST_KEYSPACE;
...
import io.debezium.connector.planetscale.pipeline.txmetadata.VitessTransactionInfo;
...
public class VitessEventMetadataProviderTest {
    ...
    public void getTransactionInfo() {
        ...
        VitessTransactionInfo info = (VitessTransactionInfo) provider.getTransactionInfo(
                ...
                VitessOffsetContext.initialContext(false, config, Clock.system()),
                null,
                valueStruct);
