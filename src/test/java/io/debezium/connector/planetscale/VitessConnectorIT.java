...
import static io.debezium.connector.planetscale.TestHelper.PK_FIELD;
import static io.debezium.connector.planetscale.TestHelper.TEST_EMPTY_SHARD_KEYSPACE;
import static io.debezium.connector.planetscale.TestHelper.TEST_HEARTBEAT_KEYSPACE;
import static io.debezium.connector.planetscale.TestHelper.TEST_NON_EMPTY_SHARD;
import static io.debezium.connector.planetscale.TestHelper.TEST_SERVER;
import static io.debezium.connector.planetscale.TestHelper.TEST_SHARD;
import static io.debezium.connector.planetscale.TestHelper.TEST_SHARD1;
import static io.debezium.connector.planetscale.TestHelper.TEST_SHARD1_EPOCH;
import static io.debezium.connector.planetscale.TestHelper.TEST_SHARD2;
import static io.debezium.connector.planetscale.TestHelper.TEST_SHARD2_EPOCH;
import static io.debezium.connector.planetscale.TestHelper.TEST_SHARDED_KEYSPACE;
import static io.debezium.connector.planetscale.TestHelper.TEST_SHARD_TO_EPOCH;
import static io.debezium.connector.planetscale.TestHelper.TEST_UNSHARDED_KEYSPACE;
import static io.debezium.connector.planetscale.TestHelper.VGTID_JSON_TEMPLATE;
...
import io.debezium.connector.planetscale.pipeline.txmetadata.VitessOrderedTransactionContext;
import io.debezium.connector.planetscale.pipeline.txmetadata.VitessOrderedTransactionMetadataFactory;
import io.debezium.connector.planetscale.pipeline.txmetadata.VitessRankProvider;
import io.debezium.connector.planetscale.transforms.RemoveField;
...
public class VitessConnectorIT extends AbstractVitessConnectorTest {
    ...
    public void shouldReceiveHeartbeatEvents() throws Exception {
        ...
        SourceRecords records = consumeRecordsByTopic(expectedHeartbeatRecords, 1);
