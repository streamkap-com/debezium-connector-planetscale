...
public class VitessValueConverter extends MySqlValueConverters {
    ...
    public static boolean isDateOrDateTime(String typeName) {
        return matcheType(typeName, Query.Type.DATETIME.name()) || matcheType(typeName, Query.Type.DATE.name());
    }
    ...
    private static boolean isTemporal(String typeName) {
        return matcheType(typeName, Query.Type.DATE.name()) ||
                matcheType(typeName, Query.Type.TIME.name()) ||
                matcheType(typeName, Query.Type.DATETIME.name());
    }
    ...
    protected boolean matches(String upperCaseTypeName, String upperCaseMatch) {
        return super.matches(upperCaseTypeName, upperCaseMatch); // Call the super method to log the match attempt
    }

    protected static boolean matcheType(String upperCaseTypeName, String upperCaseMatch) {
